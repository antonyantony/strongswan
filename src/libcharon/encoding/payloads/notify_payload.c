...
ENUM_NEXT(notify_type_names, UNITY_LOAD_BALANCE, UNITY_LOAD_BALANCE, DPD_R_U_THERE_ACK,
	"UNITY_LOAD_BALANCE");
ENUM_NEXT(notify_type_names, ENCRYPTED_PING_SUPPORTED, ENCRYPTED_PING_SUPPORTED, UNITY_LOAD_BALANCE,
	"ENCRYPTED_PING_SUPPORTED");
ENUM_NEXT(notify_type_names, USE_BEET_MODE, USE_BEET_MODE, ENCRYPTED_PING_SUPPORTED,
	"USE_BEET_MODE");
...
ENUM_NEXT(notify_type_short_names, UNITY_LOAD_BALANCE, UNITY_LOAD_BALANCE, DPD_R_U_THERE_ACK,
	"UNITY_LB");
ENUM_NEXT(notify_type_short_names, ENCRYPTED_PING_SUPPORTED, ENCRYPTED_PING_SUPPORTED, UNITY_LOAD_BALANCE,
	"ESP_PING");
ENUM_NEXT(notify_type_short_names, USE_BEET_MODE, USE_BEET_MODE, ENCRYPTED_PING_SUPPORTED,
	"BEET_MODE");
