...
ENUM_NEXT(notify_type_names, USE_BEET_MODE, USE_BEET_MODE, UNITY_LOAD_BALANCE,
	"USE_BEET_MODE");
ENUM_NEXT(notify_type_names, ME_MEDIATION, UDP_EPHEMERAL_SOURCE_PORT, USE_BEET_MODE,
	"ME_MEDIATION",
	"ME_ENDPOINT",
	"ME_CALLBACK",
	"ME_CONNECTID",
	...
	"ME_RESPONSE",
	"RADIUS_ATTRIBUTE",
	"UDP_EPHEMERAL_SOURCE_PORT");
ENUM_END(notify_type_names, UDP_EPHEMERAL_SOURCE_PORT);
...
ENUM_NEXT(notify_type_short_names, USE_BEET_MODE, USE_BEET_MODE, UNITY_LOAD_BALANCE,
	"BEET_MODE");
ENUM_NEXT(notify_type_short_names, ME_MEDIATION, UDP_EPHEMERAL_SOURCE_PORT, USE_BEET_MODE,
	"ME_MED",
	"ME_EP",
	"ME_CB",
	"ME_CID",
	...
	"RADIUS",
	"UDP_EPH_PORT");
ENUM_END(notify_type_short_names, UDP_EPHEMERAL_SOURCE_PORT);
