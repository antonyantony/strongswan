...
ENUM_NEXT(notify_type_names, UNITY_LOAD_BALANCE, UNITY_LOAD_BALANCE, DPD_R_U_THERE_ACK,
	"UNITY_LOAD_BALANCE");
ENUM_NEXT(notify_type_names, EESP_MAX_SUB_SA_ID, USE_BEET_MODE, UNITY_LOAD_BALANCE,
	"EESP_MAX_SUB_SA_ID",
	"USE_BEET_MODE");
...
ENUM_NEXT(notify_type_short_names, UNITY_LOAD_BALANCE, UNITY_LOAD_BALANCE, DPD_R_U_THERE_ACK,
	"UNITY_LB");
ENUM_NEXT(notify_type_short_names, EESP_MAX_SUB_SA_ID, EESP_MAX_SUB_SA_ID, UNITY_LOAD_BALANCE,
	"EESP_MAX_SUB_SA_ID");
ENUM_NEXT(notify_type_short_names, USE_BEET_MODE, USE_BEET_MODE, EESP_MAX_SUB_SA_ID,
	"BEET_MODE");
